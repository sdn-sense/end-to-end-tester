#!/usr/bin/env python3
"""
Setup tools script for End to End Tester.
Authors:
...
setup(
    name='EndToEndTester',
    version=f"{VERSION}",
    long_description="EndToEndTester installation",
    author="Justas Balcas",
    author_email="jbalcas@es.net",
    url="https://www.es.net/network-r-and-d/sense/",
    download_url=f"https://github.com/sdn-sense/end-to-end-tester/archive/refs/tags/{VERSION}.tar.gz",
    keywords=['system', 'monitor', 'SDN', 'end-to-end'],
    package_dir={'': 'src/python/'},
    packages=['EndToEndTester'] + list_packages(['src/python/EndToEndTester/']),
    install_requires=requirements,
    setup_requires=requirements,
    data_files=[],
    py_modules=get_py_modules(['src/python/EndToEndTester']),
)
